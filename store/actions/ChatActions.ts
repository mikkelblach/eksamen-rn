...
export const fetchChatrooms = () => {
    return async (dispatch: any, getState: any) => {
        ...
        const response = await fetch(
            'https://cbs-app-95a54-default-rtdb.europe-west1.firebasedatabase.app/chatrooms.json?auth='
            + idToken, {
...
export const deleteChatroom = (id: string) => {
    return async (dispatch: any, getState: any) => {
        ...
        const response = await fetch(
            'https://cbs-app-95a54-default-rtdb.europe-west1.firebasedatabase.app/chatrooms/' + id + '.json/?auth='
            + idToken, {
