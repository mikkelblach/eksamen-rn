...
const Screen1 = ({ navigation }: { navigation: any }) => {
    ...
    return (
        <View>
            ...
            <Button title="Same use?" onPress={() => dispatch(toggleHappy())} />
            <Button title="Use for likes/attending?" onPress={() => dispatch(add())} />
            <Button title="Use for remove likes/attending?" onPress={() => dispatch(subtract())} />
